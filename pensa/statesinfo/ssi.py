...
def ens_ssi(distr_a_input, traj1_len,  a_states=None, gauss_bins=180, gauss_smooth=None, pbc=True, write_plots=None, write_name=None):
    """
    Calculates the State Specific Information SSI [bits] between a features 
    and the change in ensembles condition. 
    ...
    distr_a_input : list of lists
        ...
        residue or water
    traj1_len : int
        Number of frames in the first trajectory.
